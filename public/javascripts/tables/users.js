...
$(document).ready(function(){
    ...
    $("table tbody tr td .btn-info").click(function(){
        console.log("makeee");
        let button = $(this);
        ...
        row.children().each(function () {
            ...
            if(key === "_id"){
                let val = $(this).find("div").text();
                let butVal = button.text();
                let data;
                if(butVal === "Make Admin"){
                    data = {_id : val, admin: "Yes"};
                }else{
                    data = {_id : val, admin: "No"};
                }
